...
import 'list2_products_model.dart';
export 'list2_products_model.dart';

class List2ProductsWidget extends StatefulWidget {
  const List2ProductsWidget({Key? key}) : super(key: key);

  @override
  _List2ProductsWidgetState createState() => _List2ProductsWidgetState();
}

class _List2ProductsWidgetState extends State<List2ProductsWidget> {
  late List2ProductsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => List2ProductsModel());
